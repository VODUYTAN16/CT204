...
\hspace*{2em} Mã hóa là quá trình chuyển đổi thông tin từ dạng có thể đọc hiểu (dữ liệu gốc) sang dạng biểu diễn không thể giải đoán hoặc nhận diện trực tiếp nếu thiếu khóa mã hóa phù hợp. Việc này giúp bảo vệ nội dung khỏi truy cập trái phép trong quá trình lưu trữ hoặc truyền đi, đảm bảo chỉ người có quyền mới đọc được dữ liệu thật.

\indent Ngược lại, giải mã là quá trình khôi phục lại dữ liệu ban đầu từ dạng mã hóa. Người nhận sẽ dùng khóa giải mã tương ứng để mở khóa dữ liệu, từ đó đọc được thông tin gốc. Đây là bước cuối cùng để đảm bảo thông tin được truyền tải an toàn, chính xác và toàn vẹn giữa các bên.
