...
\indent Thuật toán RSA (Rivest – Shamir – Adleman) là một trong những thuật toán mã hóa bất đối xứng phổ biến và có tính ứng dụng cao nhất hiện nay do khả năng bảo mật của nó mang lại. RSA được phát triển vào năm 1977 bởi ba nhà khoa học Ronald Rivest, Adi Shamir và Leonard Adleman, dựa trên nguyên lý toán học của phép nhân và phân tích thừa số nguyên tố lớn.
...
\begin{itemize}
  \item \textbf{Giai đoạn 1 – Sinh khóa:} Hai số nguyên tố lớn p và q rất lớn được chọn để tính modulo n=p×q và giá trị Φ(n)=(p−1)(q−1). Sau đó chọn khóa công khai e và tính khóa bí mật d sao cho e×d≡1 mod  Φ(n).

  \item \textbf{Giai đoạn 2 – Mã hóa:}Thông điệp ban đầu M được mã hóa thành bản mã C=Me mod  n bằng khóa công khai.

  \item \textbf{Giai đoạn 3 – Giải mã:} Người nhận sử dụng khóa bí mật để giải mã nội dung M=Cd mod  n khôi phục lại nội dung ban đầu.
\end{itemize}

\indent Quy trình cho thấy độ an toàn của RSA đến từ việc khó phân tích modulo để tìm ra hai số nguyên tố p và q rất lớn, từ đó đảm bảo tính bảo mật và độ tin cậy của hệ thống mã hóa.
