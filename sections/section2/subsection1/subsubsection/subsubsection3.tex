...
\indent \textbf{Công nghệ:} Ứng dụng được phát triển bằng \textit{Flutter/Dart} ở phía \textit{client} và \textit{Node.js/Express} ở phía \textit{server}.  
...
\indent \textbf{Cấu trúc hoạt động:} Trong giai đoạn phát triển, \textit{client} kết nối tới máy chủ thông qua địa chỉ cấu hình nội bộ. Khi người dùng tham gia vào một cuộc trò chuyện đồng nghĩa với việc đăng kỳ vào một flow của Websocket để sẵn sàng nhận dữ liệu broadcast khi có tin nhắn mới. 
