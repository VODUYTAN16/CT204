...
\indent Hình ~\ref{fig:profile} là giao diện hiển thị thông tin cá nhân của người dùng sau khi đăng nhập.  
...
Người dùng có thể sử dụng nút \textbf{Đăng xuất} để thoát khỏi ứng dụng.
...
\indent Qua các giao diện đã trình bày, có thể thấy ứng dụng được thiết kế với bố cục trực quan, nhất quán và thân thiện với người dùng.  
