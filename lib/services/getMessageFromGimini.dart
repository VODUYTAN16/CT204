...
Future<String?> sendToGimini(String userMessage) async {
  ...
  if (currentChat?.messages != null && currentChat!.messages.length > 1) {
    ...
    final recentMessages = currentChat!.messages
        .sublist((currentChat!.messages.length - 6).clamp(0,
  ...
  final prompt = 'Bạn có thể tham khảo lịch sử trò chuyện: $messageHistory : để trả lời ngắn gọn cho câu sau: ${userMessage}\n Phản hồi bằng tiếng việt';
